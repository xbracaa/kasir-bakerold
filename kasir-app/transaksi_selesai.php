...
$data = $koneksi->query("SELECT * FROM transaksi WHERE kode_transaksi = '$kode'")->fetch_assoc();
if (!$data) {
    echo "Transaksi tidak ditemukan.";
    exit;
}

$kasir = $koneksi->query("SELECT nama_kasir FROM kasir WHERE id_kasir = {$data['id_kasir']}")->fetch_assoc();
?>
...
<div class="ringkasan">
    ...
    <p><strong>Kasir:</strong> <?= $kasir['nama_kasir'] ?></p>
...
<div class="btn">
    <a href="print_struk.php?kode=<?= $kode ?>" target="_blank">Cetak Struk</a>
</div>
