...
$produk_query = $koneksi->query("SELECT * FROM produk ORDER BY nama_produk ASC"); // Order products for better display
...
// Display success alert if a transaction was just completed
if (isset($_GET['status']) && $_GET['status'] == 'success') {
    $kembalian = number_format($_GET['kembalian'], 0, ',', '.');
    echo <<<HTML
          <script>
            document.addEventListener('DOMContentLoaded', function() {
                const alertDiv = document.createElement('div');
                alertDiv.className = 'alert alert-success alert-dismissible fade show mx-auto mt-3';
                alertDiv.role = 'alert';
                alertDiv.style.maxWidth = '600px';
                alertDiv.innerHTML = `
                    <strong>Transaksi Berhasil!</strong> Kembalian: Rp ${kembalian}.
    ...
    HTML; // Must be on its own line, no leading/trailing spaces.
}
?>
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="card sticky-top" style="top: 20px;"> <div class="card-header cart-header">
